            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr id="role-<?php echo e($role->id); ?>">
                        ...
                        <td>
                            <a href="javascript:;" data-role-id="<?php echo e($role->id); ?>" class="btn btn-sm btn-info btn-rounded edit-category"><?php echo app('translator')->getFromJson("app.edit"); ?></a>
                            <?php if($role->id > 1): ?>
...
<?php /**PATH C:\laragon\www\my_carear\myCareer\resources\views/admin/role-permission/create.blade.php ENDPATH**/ ?>