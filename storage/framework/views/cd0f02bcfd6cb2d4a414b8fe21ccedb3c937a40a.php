            ...
            <div class="row">
                <div class="col-md-6  col-xs-12">
                    <div class="form-group">
                        ...
                        <select disabled class="select2 m-b-10 form-control" data-placeholder="<?php echo app('translator')->getFromJson('modules.interviewSchedule.chooseCandidate'); ?>">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select class="select2 m-b-10 form-control select2-multiple " multiple="multiple" data-placeholder="<?php echo app('translator')->getFromJson('modules.interviewSchedule.chooseEmployee'); ?>" name="employee[]" id="employee">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-success update-schedule"><?php echo app('translator')->getFromJson('app.update'); ?></button>
</div>
...
<?php /**PATH C:\laragon\www\my_carear\myCareer\resources\views/admin/interview-schedule/edit.blade.php ENDPATH**/ ?>