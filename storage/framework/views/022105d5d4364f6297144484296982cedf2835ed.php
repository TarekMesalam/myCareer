<nav class="navbar navbar-expand-lg navbar-light bg-white">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(url('/')); ?>/front/new_assets/images/logo.svg" alt="NCMS Jobs" width="142">
        </a>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo e(route('login')); ?>">
                        <img src="<?php echo e(url('/')); ?>/front/new_assets/images/thump.svg" alt="NCMS Login">
                    </a>
                </li>
...
</nav> <!-- /Navbar --><?php /**PATH C:\laragon\www\my_carear\myCareer\resources\views/sections/header.blade.php ENDPATH**/ ?>