                    ...
                    @foreach($roles as $role)
                        <div class="col-md-12 b-all mt-2">
                            <div class="row">
                                ...
                                <div class="col-md-12 b-t permission-section" id="role-permission-{{ $role->id }}" >
                                    <table class="table ">
                                        <thead>
                                            <tr class="bg-white">
                                                <th>
                                                    ...
                                                    <td>
                                                        <div class="switchery-demo">
                                                            <input type="checkbox"
                                                                ...
                                                                checked
                                                                @endif
                                                                class="js-switch assign-role-permission permission_{{ $role->id }}" data-size="small" data-color="#1b274a" data-permission-id="{{ $permission->id }}" data-role-id="{{ $role->id }}" />
                                                        </div>
                                                    </td>
                                                @endforeach
