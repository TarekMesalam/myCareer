            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form id="form-status-change" class="form-inline justify-content-lg-end ">
                                <div class="form-group mr-3">
                                    <select name="statusMultiple" id="statusMultiple" class="form-control">
    ...
    <script>
        ...
        $('#changeMultipleStatus').on('click', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    changeMultipleStatus(status , "@lang('app.yes')")
                }
                else{
                    changeMultipleStatus(status , "@lang('app.no')")
                }
            });
            }else{
                $.showToastr("@lang('messages.emptyCheckBox')", "@lang('messages.error')");
            }
        });
