            ...
            <div class="col-6">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label class="">
                            <div id="div-interview-schedule-rejected" class="iradio_minimal-blue " onclick="statusChange('rejected')"  aria-checked="" aria-disabled="false"><input type="radio" @if($schedule->status == 'rejected') checked @endif  name="r1" class="minimal"><ins class="iCheck-helper"></ins></div>
                            @lang('app.rejected')
                        </label><label class="">
                            <div id="div-interview-schedule-hired" class="iradio_minimal-blue" onclick="statusChange('hired')"   aria-checked="" aria-disabled="false"><input type="radio" @if($schedule->status == 'hired') checked @endif  name="r1" class="minimal"><ins class="iCheck-helper"></ins></div>
                            @lang('app.hired')
                        </label>
                        <label class="">
                            <div id="div-interview-schedule-pending" class="iradio_minimal-blue" onclick="statusChange('pending')"   aria-checked="" aria-disabled="false"><input type="radio" @if($schedule->status == 'pending') checked @endif  name="r1" class="minimal"><ins class="iCheck-helper"></ins></div>
                            @lang('app.pending')
                        </label>
                        <label class="">
                            <div id="div-interview-schedule-canceled" class="iradio_minimal-blue" onclick="statusChange('canceled')"   aria-checked="" aria-disabled="false"><input type="radio" @if($schedule->status == 'canceled') checked @endif  name="r1" class="minimal"><ins class="iCheck-helper"></ins></div>
                            @lang('app.canceled')
                        </label>
                    </div>
                </div>
