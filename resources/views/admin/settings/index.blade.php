            ...
            <div class="card">
                <div class="card-body">
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div class="form-group">
                            {{--<a href="javascript:;" id="getLocation" class="btn btn-warning m-b-10"><i class="ti-location-pin"></i> @lang('modules.accountSettings.getLocation')</a>--}}
    ...
    <script>
        ...
        function geocodePosition(pos) {
            geocoder.geocode({
                ...
                if (responses && responses.length > 0) {
                    ...
                    updateMarkerAddress("@lang('messages.cannotDetermineAddress')");
                }
            });
        }
        ...
        function initialize() {
            ...
            google.maps.event.addListener(marker, 'dragstart', function () {
                updateMarkerAddress("@lang('messages.dragging')");
            });

            google.maps.event.addListener(marker, 'drag', function () {
                updateMarkerStatus("@lang('messages.dragging')");
                updateMarkerPosition(marker.getPosition());
            });

            google.maps.event.addListener(marker, 'dragend', function () {
                updateMarkerStatus("@lang('messages.dragEnded')");
