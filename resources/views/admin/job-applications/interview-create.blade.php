            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select class="select2 m-b-10 form-control select2-multiple " multiple="multiple" data-placeholder="@lang('modules.interviewSchedule.chooseEmployee')" data-placeholder="@lang('modules.interviewSchedule.employee')" name="employee[]">
