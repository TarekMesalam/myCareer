                        ...
                        <div class="row">
                            <div class="custom-column panel-scroll">
                                @foreach($column->applications as $application)
                                    <div class="panel panel-default lobipanel show-detail " data-widget="control-sidebar" data-slide="true" data-row-id="{{ $application->id }}" data-application-id="{{ $application->id }}" data-sortable="true">
                                        <div class="panel-body ">
                                            <h5>
                                                <img src="{{$application->photo_url}}" alt="user" class="img-circle" width="25"> {{ ucwords($application->full_name) }}
                                            </h5>
...
<script>
    ...
    $(function () {
        var boardStracture = JSON.parse('{!! $boardStracture !!}');
