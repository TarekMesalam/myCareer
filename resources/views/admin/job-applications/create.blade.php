        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @if(count($jobs) == 0)
                        <div id="no-jobs" class="alert alert-danger alert-dismissible fade show">
                            <h4 class="alert-heading"><i class="fa fa-warning"></i> @lang('messages.noJobWarning')</h4>
                            <p>@lang('messages.noJobs')
                                <a href="{{ route('admin.jobs.create') }}" class="btn btn-info btn-sm m-l-15"><i class="fa fa-plus-circle"></i> @lang('app.createNew') @lang('menu.jobs')</a>
                            </p>
                        </div>
                    @else
                        <form class="ajax-form" method="POST" id="createForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 pt-4 b-b" id="questionBox"></div>
                            </div>
                            <br>
