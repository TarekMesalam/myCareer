                    ...
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div id="alert">
                            @if($smtpSetting->mail_driver =='smtp')
                                @if($smtpSetting->verified)
                                    <div class="alert alert-success">@lang('messages.smtpSuccess')</div>
                                @else
                                    <div class="alert alert-danger">@lang('messages.smtpError')</div>
                                @endif
                            @endif
                        </div>
                        ...
                        <div id="smtp_div">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="mail_host" name="mail_host" value="{{ $smtpSetting->mail_host }}">
                            </div>
                            <div class="form-group">
                                <label for="mail_port">@lang('app.mailPort')</label>
                                <input type="text" class="form-control" id="mail_port" name="mail_port" value="{{ $smtpSetting->mail_port }}">
                            </div>
                            <div class="form-group">
                                <label for="mail_username">@lang('app.mailUsername')</label>
                                <input type="text" class="form-control" id="mail_username" name="mail_username" value="{{ $smtpSetting->mail_username }}">
                            </div>
                            <div class="form-group">
                                <label for="mail_password">@lang('app.mailPassword')</label>
                                <input type="text" class="form-control" id="mail_password" name="mail_password" value="{{ $smtpSetting->mail_password }}">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mail_from_name" name="mail_from_name" value="{{ $smtpSetting->mail_from_name }}">
                        </div>
                        <div class="form-group">
                            <label for="mail_from_email">@lang('app.mailFromEmail')</label>
                            <input type="email" class="form-control" id="mail_from_email" name="mail_from_email" value="{{ $smtpSetting->mail_from_email }}">
                        </div>
            ...
            $.easyAjax({
                ...
                success: function (response) {
                    if (response.status == 'error') {
                        $('#alert').prepend('<div class="alert alert-danger">@lang('messages.smtpError')</div>')
                    } else {
                        $('#alert').show();
                    }
                }
