                        ...
                        <div class="row">
                            <div id="addMoreBox1" class="col-md-12">
                                <div class="row">
                                    ...
                                    <div id="job_questions_multiple_remove" class="col-md-1">
                            ...
                            <div id="job_questions_multiple_add" class="col-md-12">
                                <button type="button" id="plusButton" class="btn btn-sm btn-info">@lang('app.addMore') <i class="fa fa-plus"></i></button>
                            </div>
                        </div>
